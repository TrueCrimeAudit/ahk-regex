...
`;
    const languages = ['javascript', 'ahk2', 'autohotkey2', 'ahk', 'autohotkey', 'javascriptreact', 'typescript', 'typescriptreact', 'vue', 'php', 'haxe'];
    ...
    function getRegexRegex(languageId) {
        ...
        else if (languageId == 'ahk' || languageId == 'autohotkey' || languageId == 'ahk2' || languageId == 'autohotkey2') {
            return ahkRegexRegex;
        }
        return regexRegex;
    }
